...
const showModInfo = (parent, data) => {
	...
	if (data.images) {
		...
		images.className = "main-menu-settings__scroll-wrapper";
		images.id = "modinfo";
...
function createConfigurationControl({
	...
	slider.style.justifyContent = "space-beetween";

	const valueEl = document.createElement("div");
	valueEl.style.fontFamily = "HeadingNowBold";
	valueEl.style.color = "#ffffff";
	valueEl.style.textTransform = "uppercase";
	valueEl.style.fontSize = "max( calc( ( 16 * var(--global-scale) * var(--global-scale) - 16 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 16 * var(--global-scale) * var(--global-scale) * 0.44 - ( 16 * var(--global-scale) * var(--global-scale) - 16 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px );";
	valueEl.style.width = "max( calc( ( 16 * var(--global-scale) * var(--global-scale) - 16 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 16 * var(--global-scale) * var(--global-scale) * 0.44 - ( 16 * var(--global-scale) * var(--global-scale) - 16 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px );";
	...
	progressBar.style.background = "rgba(17, 17, 17, 0.5);";
	progressBar.style.borderStyle = "solid";
	progressBar.style.borderColor = "rgba(255, 255, 255, 0.1);";
	progressBar.style.maxWidth = "max( calc( ( 339 * var(--global-scale) * var(--global-scale) - 339 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 339 * var(--global-scale) * var(--global-scale) * 0.44 - ( 339 * var(--global-scale) * var(--global-scale) - 339 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px );";
	progressBar.style.height = "max( calc( ( 26 * var(--global-scale) * var(--global-scale) - 26 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 26 * var(--global-scale) * var(--global-scale) * 0.44 - ( 26 * var(--global-scale) * var(--global-scale) - 26 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px );";
	progressBar.style.padding = "max( calc( ( 3 * var(--global-scale) * var(--global-scale) - 3 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 3 * var(--global-scale) * var(--global-scale) * 0.44 - ( 3 * var(--global-scale) * var(--global-scale) - 3 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px );";
	progressBar.style.borderRadius = "max( calc( ( 7 * var(--global-scale) * var(--global-scale) - 7 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 7 * var(--global-scale) * var(--global-scale) * 0.44 - ( 7 * var(--global-scale) * var(--global-scale) - 7 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px );";
	progressBar.style.borderWidth = "max( calc( ( 1 * var(--global-scale) * var(--global-scale) - 1 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 1 * var(--global-scale) * var(--global-scale) * 0.44 - ( 1 * var(--global-scale) * var(--global-scale) - 1 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px );";

	const inner = document.createElement("div");
	inner.style.position = "absolute";
	inner.style.left = "max( calc( ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 4 * var(--global-scale) * var(--global-scale) * 0.44 - ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";
	inner.style.right = "max( calc( ( 24 * var(--global-scale) * var(--global-scale) - 24 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 24 * var(--global-scale) * var(--global-scale) * 0.44 - ( 24 * var(--global-scale) * var(--global-scale) - 24 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";
	inner.style.height = "max( calc( ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 20 * var(--global-scale) * var(--global-scale) * 0.44 - ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";

	const active = document.createElement("div");
	active.style.position = "relative";
	active.style.width = "var(--progress)";
	active.style.backgroundColor = "rgba(255, 255, 255, 0.2)";
	active.style.backgroundImage = "var(--gradient)";
	active.style.borderTopLeftRadius = "max( calc( ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 4 * var(--global-scale) * var(--global-scale) * 0.44 - ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";
	active.style.borderBottomLeftRadius = "max( calc( ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 4 * var(--global-scale) * var(--global-scale) * 0.44 - ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";
	active.style.height = "max( calc( ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 20 * var(--global-scale) * var(--global-scale) * 0.44 - ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";

	const tracker = document.createElement("div");
	tracker.style.position = "absolute";
	tracker.style.right = "0";
	tracker.style.backgroundColor = "#ffffff";
	tracker.style.boxShadow = "0px 0px 12px 0px rgba(255, 255, 255, 0.5)";
	tracker.style.transform = "translateX(100%)";
	tracker.style.width = "max( calc( ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 20 * var(--global-scale) * var(--global-scale) * 0.44 - ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";
	tracker.style.height = "max( calc( ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 20 * var(--global-scale) * var(--global-scale) * 0.44 - ( 20 * var(--global-scale) * var(--global-scale) - 20 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";
	tracker.style.borderRadius = "max( calc( ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / (1920 * var(--global-scale) - 800 * var(--global-scale)) ) * 100vw + calc( ( 4 * var(--global-scale) * var(--global-scale) * 0.44 - ( 4 * var(--global-scale) * var(--global-scale) - 4 * var(--global-scale) * var(--global-scale) * 0.44 ) / ( 1920 * var(--global-scale) - 800 * var(--global-scale) ) * 800 * var(--global-scale) ) * 1px ), 1px )";
